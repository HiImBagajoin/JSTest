...
for (i = 0; i < employees.length; i++) {
    ...
    num1 = parseInt(work_end_hour);
    num2 = parseInt(work_begin_hour);
    //將工作結束、開始時間轉換為int
    total_work_time += num1 - num2;
    //將結束工作的時間減去開始上班的時間，獲得該員工一天上班時間，並逐一存放至total_work_time
}
document.write(total_work_time);